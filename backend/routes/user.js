...
<<<<<<< HEAD
    ...
    var Converted = ''+getYear+getMonth+getDay+getSec;
    var AlphabetArr = 
        ['a','b','c','d','e',
        'f','g','h','i','j',
        'k','l','m','n','o',
    ...
    var po_view_count = req.body.po_view_count;
    var po_apply_count = req.body.po_apply_count;
    var po_title = req.body.po_title;
    var genre_number = parseInt(req.body.genre_number);
    var po_type= req.body.po_type;
    var po_desc = req.body.po_desc;
    ...
    var FilePath = `./data/${user_id}`;//po_file_path
